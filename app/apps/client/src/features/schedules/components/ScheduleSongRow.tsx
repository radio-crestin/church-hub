 ...
 * a sung checkmark, the title with its category / key line / tags, and an X to
 * drop it from the program. Kept visually identical to `SortableBookmarkItem`
 * on purpose — the operator reads both lists the same way — minus the drag
 * handle, since ordering inside a program is owned by the schedule editor.
 */
  ...
  return (
    ...
    >
      <button
        ...
        className={`ml-1.5 flex-shrink-0 flex h-5 w-5 items-center justify-center rounded-full border transition-colors ${
          item.isSung
